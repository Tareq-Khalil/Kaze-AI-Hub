...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    console.log('Attempting to send to:', `${API_BASE_URL}/api/contact`);
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-300 dark:border-gray-700">
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                />
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 dark:text-white">Tareq Khalil</h3>
                  <p className="text-purple-600 dark:text-purple-400">Project Admin & Lead Developer</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Kaze AI</p>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-300 dark:border-gray-700">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">tareq@soac.club</span>
                </div>
                <div className="flex items-center space-x-3">
