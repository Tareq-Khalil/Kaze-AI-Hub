...
import { Code, GitBranch, Star, ExternalLink, Github, Linkedin, Mail, Twitter } from 'lucide-react';
...
const Contribute: React.FC = () => {
  ...
  const contributors = [
    ...
    },   
    {
      ...
      linkedin: 'https://www.linkedin.com/in/eyad-gamal-gouda-a7987a363/',
      twitter: 'https://x.com/EyadGam74169210',
      mail: 'mailto:eyad.2124017@stemobour.moe.edu.eg',
    },
    {
      ...
      mail: 'mailto:ellawaty2009@gmail.com',
    }
  ];
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {contributors.map((contributor, index) => (
              <motion.div
                ...
                className="bg-gray-100 dark:bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-300 dark:border-gray-700 hover:border-purple-500 transition-all duration-300 text-center hover:shadow-lg"
              >
                <div className="mb-6">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src = `https://api.dicebear.com/7.x/initials/svg?seed=${contributor.name}&backgroundColor=6366f1&color=ffffff`;
                    }}
                  />
                </div>
                <h3 className="text-xl font-semibold mb-2">{contributor.name}</h3>
                <p className="text-purple-600 dark:text-purple-400 mb-6 text-sm">{contributor.subheading}</p>
